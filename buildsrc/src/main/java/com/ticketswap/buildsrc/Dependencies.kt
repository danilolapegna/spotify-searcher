object Version {
    const val gsonVersion: String = "2.7"
    ...
    const val realmVersion = "5.14.0"

    // Android Architecture
    val lifecycleVersion = "1.1.1"
    val navigationVersion = "1.0.0-alpha06"

    val materialSearchVersion = "0.8.2"
}

object Storage {
    val realm = "io.realm:realm-gradle-plugin:${Version.realmVersion}"
}
...
object Dependencies {
    ...
    val applicationId = "com.spotifysearch"
    val versionCode = 1
    val versionName = "1.0"
}
...
object Libs {
    ...
    val materialSearch = "com.github.mancj:MaterialSearchBar:${Version.materialSearchVersion}"
}
